    ...
    <html lang="en" className={`${inter.variable} ${orbitron.variable}`}>
      <body className="min-h-screen bg-black text-white font-sans antialiased overflow-x-hidden">
        ...
        <div className="fixed inset-0 -z-10 overflow-hidden">
          ...
          <div className="absolute bottom-1/3 -right-20 w-80 h-80 bg-gradient-to-l from-red-500/15 to-orange-500/15 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute top-2/3 left-1/3 w-64 h-64 bg-green-400/10 rounded-full blur-2xl animate-pulse"></div>
